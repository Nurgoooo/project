...
with open(r"C:\Users\Asus\Desktop\Workspace\Nurait things\Python 3.13\py313\nur\projectbay\materials\proba.json", "r", encoding="utf-8") as file:
...
def finish_test():
    ...
    result_text = f"Тест завершён!\nПравильных ответов: {score} из {len(shuffled_questions)}\nВремя прохождения: {minutes:02d}:{seconds:02d}"
    messagebox.showinfo(title="Результат теста", message=result_text)
    app.destroy()
